  ...
  return (
    <main className="flex w-full h-screen overflow-hidden">
      ...
      <div className="w-full">
        <header className="py-3 px-5 w-full h-fit flex items-center justify-between border-b">
          <h1 className="text-3xl font-bold">Notes</h1>
          <div className="flex items-center gap-3">
            <a target="_blank" href="https://t.me/islom_ipm">
              <img
                className="size-8 rounded-full"
                src="https://img.logo.dev/t.me?token=live_6a1a28fd-6420-4492-aeb0-b297461d9de2&retina=true&size=200&format=jpg&greyscale=false"
                alt=""
              />
            </a>
            <a target="_blank" href="https://github.com/islom-pardaboyev">
              <img
                className="size-8 rounded-full"
                src="https://img.logo.dev/github.com?token=live_6a1a28fd-6420-4492-aeb0-b297461d9de2&retina=true&size=200&format=jpg&greyscale=false"
                alt=""
              />
            </a>
          </div>
